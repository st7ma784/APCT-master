...
class parser(HyperOptArgumentParser):
    def __init__(self,*args,strategy="grid_search"):
        ...
        self.add_argument("--dir",default="/nobackup/projects/$USER/smander3/data/",type=str)
        self.add_argument("--log_path",default="/nobackup/projects/$USER/smander3/logs/",type=str)
