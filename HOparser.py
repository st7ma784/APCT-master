...
class parser(HyperOptArgumentParser):
    def __init__(self,*args,strategy="random_search",**kwargs):
        ...
        self.opt_list("--learning_rate", default=0.00001, type=float, options=[1e-5, 2e-4,1e-4,5e-5], tunable=True)
        self.opt_list("--batch_size", default=8, type=int, options=[6,8,10], tunable=True)
        self.opt_list("--JSE", default=0, type=int, options=[1,0], tunable=True)
        self.opt_list("--precision", default=16, options=[16], tunable=False)
        self.opt_list("--codeversion", default=4, type=int, options=[1,3,4], tunable=False)
        ...
        self.opt_list("--embed_dim", default=512, type=int, options=[128,256,512], tunable=True)
        self.opt_list("--transformer_width", default=512, type=int, options=[128,256,512], tunable=True)
