...
from trainclip_v2 import wandbtrain as train_clip
...
#        test_tube_exp_name="PL_test"
    ...
    cluster.optimize_parallel_cluster_gpu(train, nb_trials=2, job_name='second_wandb_trial_batch') # Change this to optimize_parralel_cluster_cpu to debug.
